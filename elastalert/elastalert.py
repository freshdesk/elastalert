...
class ElastAlerter(object):
    ...
    @tracer.start_as_current_span("get_terms_query")
    ...
    @tracer.start_as_current_span("get_aggregation_query")
    ...
    @tracer.start_as_current_span("get_index_start")
    ...
    @tracer.start_as_current_span("get_hits")
    ...
    @tracer.start_as_current_span("get_terms_data")
    ...
    @tracer.start_as_current_span("get_hits_count")
    ...
    @tracer.start_as_current_span("get_hits_terms")
    ...
    @tracer.start_as_current_span("get_hits_aggregation")
